        ...
        <div className="space-y-3 max-w-2xl">
          {values.map((v, i) => (
            <motion.div
              ...
              className="rounded-xl border border-border bg-surface/50 overflow-hidden cursor-pointer group hover:border-cyan/30 transition-all duration-300"
            ...
            >
              <div className="flex items-center justify-between px-5 py-4">
                ...
                <motion.span
                  ...
                  className="text-ghost/50 text-sm shrink-0 ml-3"
                >
                  ▾
                </motion.span>
              </div>
              ...
              <AnimatePresence>
                {openIdx === i && (
                  ...
                  >
                    <p className="px-5 pb-5 text-ghost text-sm leading-relaxed border-t border-border/40 pt-4">
                      {v.detail}
                    </p>
                  </motion.div>
                )}
